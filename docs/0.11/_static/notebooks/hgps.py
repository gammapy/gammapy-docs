...
# 
# * From [gammapy](https://docs.gammapy.org/), we will use [gammapy.maps.WcsNDMap](https://docs.gammapy.org/0.11/api/gammapy.maps.WcsNDMap.html) to work with the HGPS sky maps, and [gammapy.catalog.SourceCatalogHGPS](https://docs.gammapy.org/0.11/api/gammapy.catalog.SourceCatalogHGPS.html) and [gammapy.catalog.SourceCatalogObjectHGPS](https://docs.gammapy.org/0.11/api/gammapy.catalog.SourceCatalogObjectHGPS.html) to work with the HGPS catalog data, especially the HGPS spectral data using [gammapy.spectrum.models.SpectralModel](https://docs.gammapy.org/0.11/api/gammapy.spectrum.models.SpectralModel.html) and [gammapy.spectrum.FluxPoints](https://docs.gammapy.org/0.11/api/gammapy.spectrum.FluxPoints.html) objects.
# 
# * [matplotlib](https://matplotlib.org/) for all plotting. For sky image plotting, we will use matplotlib via [astropy.visualization](http://docs.astropy.org/en/stable/visualization/index.html) and [gammapy.maps.WcsNDMap.plot](https://docs.gammapy.org/0.11/api/gammapy.maps.WcsNDMap.html#gammapy.maps.WcsNDMap.plot).
# 
# If you're not familiar with Python, Numpy, Astropy, Gammapy or matplotlib yet, use the tutorial introductions as explained [here](https://docs.gammapy.org/0.11/tutorials.html), as well as the links to the documentation that we just mentioned.
...
# and stored on the ``cat`` object. See the [SourceCatalogHGPS](https://docs.gammapy.org/0.11/api/gammapy.catalog.SourceCatalogHGPS.html) docs, or just try accessing one:
...
# This creates [SourceCatalogObjectHGPS](https://docs.gammapy.org/0.11/api/gammapy.catalog.SourceCatalogObjectHGPS.html) objects that have a copy of all the data for a given source. See the class docs for a full overview.
...
# ## Maps with Gammapy
# 
# Let's use the [gammapy.maps.Map.read](https://docs.gammapy.org/0.11/api/gammapy.maps.Map.html#gammapy.maps.Map.read) method to load up the HGPS significance survey map.
