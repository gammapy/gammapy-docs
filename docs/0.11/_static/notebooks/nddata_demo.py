...
# ## Introduction
# 
# This notebook explains how to use the class [gammapy.utils.nddata.NDDataArray](https://docs.gammapy.org/0.11/api/gammapy.utils.nddata.NDDataArray.html)
# 
...
# * [gammapy.irf.EffectiveAreaTable2D](https://docs.gammapy.org/0.11/api/gammapy.irf.EffectiveAreaTable2D.html)
# * [gammapy.irf.EnergyDispersion](https://docs.gammapy.org/0.11/api/gammapy.irf.EnergyDispersion.html)
# * [gammapy.spectrum.CountsSpectrum](https://docs.gammapy.org/0.11/api/gammapy.spectrum.CountsSpectrum.html)
