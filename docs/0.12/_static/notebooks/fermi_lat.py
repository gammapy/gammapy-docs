...
# 
# To load the isotropic diffuse model with Gammapy, use the [gammapy.spectrum.models.TableModel](https://docs.gammapy.org/0.12/api/gammapy.spectrum.models.TableModel.html). We are using `'fill_value': 'extrapolate'` to extrapolate the model above 500 GeV:
