...
# 
# * [gammapy.time.LightCurve](https://docs.gammapy.org/0.12/api/gammapy.time.LightCurve.html)
# * [gammapy.time.LightCurveEstimator](https://docs.gammapy.org/0.12/api/gammapy.time.LightCurveEstimator.html)
# 
# ## Setup
# 
