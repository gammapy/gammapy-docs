...
# 
# - [gammapy.spectrum.FluxPointsDataset](https://docs.gammapy.org/0.12/spectrum/index.html#reference-api)
# 
# In addition we will work with the following data classes:
# 
# - [gammapy.spectrum.FluxPoints](https://docs.gammapy.org/0.12/api/gammapy.spectrum.FluxPoints.html)
# - [gammapy.catalog.SourceCatalogGammaCat](https://docs.gammapy.org/0.12/api/gammapy.catalog.SourceCatalogGammaCat.html)
# - [gammapy.catalog.SourceCatalog3FHL](https://docs.gammapy.org/0.12/api/gammapy.catalog.SourceCatalog3FHL.html)
# - [gammapy.catalog.SourceCatalog3FGL](https://docs.gammapy.org/0.12/api/gammapy.catalog.SourceCatalog3FGL.html)
# 
# And the following spectral model classes:
# 
# - [PowerLaw](https://docs.gammapy.org/0.12/api/gammapy.spectrum.models.PowerLaw.html)
# - [ExponentialCutoffPowerLaw](https://docs.gammapy.org/0.12/api/gammapy.spectrum.models.ExponentialCutoffPowerLaw.html)
# - [LogParabola](https://docs.gammapy.org/0.12/api/gammapy.spectrum.models.LogParabola.html)
...
# ## Power Law Fit
# 
# First we start with fitting a simple [power law](https://docs.gammapy.org/0.12/api/gammapy.spectrum.models.PowerLaw.html#gammapy.spectrum.models.PowerLaw).
...
# 
# Next we fit an [exponential cut-off power](https://docs.gammapy.org/0.12/api/gammapy.spectrum.models.ExponentialCutoffPowerLaw.html#gammapy.spectrum.models.ExponentialCutoffPowerLaw) law to the data.
...
# ## Log-Parabola Fit
# 
# Finally we try to fit a [log-parabola](https://docs.gammapy.org/0.12/api/gammapy.spectrum.models.LogParabola.html#gammapy.spectrum.models.LogParabola) model:
