...
get_ipython().run_cell_magic('time', '', 'result_scipy = fit_scipy.run([dataset_hess])')
...
get_ipython().run_cell_magic('time', '', 'fit = Fit(store_trace=True)\nminuit_opts = {"tol": 0.001, "strategy": 1}\nfit.backend = "minuit"\nfit.optimize_opts = minuit_opts\nresult_minuit = fit.run([dataset_hess])')
