...
# ## Introduction
# 
# This notebook explains how to use the class [gammapy.utils.nddata.NDDataArray](http://docs.gammapy.org/0.8/api/gammapy.utils.nddata.NDDataArray.html)
# 
...
# 
# * [gammapy.irf.EffectiveAreaTable](http://docs.gammapy.org/0.8/api/gammapy.irf.EffectiveAreaTable.html)
# * [gammapy.irf.EffectiveAreaTable2D](http://docs.gammapy.org/0.8/api/gammapy.irf.EffectiveAreaTable2D.html)
# * [gammapy.irf.EnergyDispersion](http://docs.gammapy.org/0.8/api/gammapy.irf.EnergyDispersion.html)
# * [gammapy.spectrum.CountsSpectrum](http://docs.gammapy.org/0.8/api/gammapy.spectrum.CountsSpectrum.html)
