...
# Data handling:
# 
# * [gammapy.data.DataStore](http://docs.gammapy.org/0.8/api/gammapy.data.DataStore.html)
# * [gammapy.data.DataStoreObservation](http://docs.gammapy.org/0.8/api/gammapy.data.DataStoreObservation.html)
# * [gammapy.data.ObservationStats](http://docs.gammapy.org/0.8/api/gammapy.data.ObservationStats.html)
# * [gammapy.data.ObservationSummary](http://docs.gammapy.org/0.8/api/gammapy.data.ObservationSummary.html)
# 
...
# * [gammapy.spectrum.SpectrumExtraction](http://docs.gammapy.org/0.8/api/gammapy.spectrum.SpectrumExtraction.html)
# * [gammapy.background.ReflectedRegionsBackgroundEstimator](http://docs.gammapy.org/0.8/api/gammapy.background.ReflectedRegionsBackgroundEstimator.html)
# 
# 
...
# * [gammapy.spectrum.models.ExponentialCutoffPowerLaw](http://docs.gammapy.org/0.8/api/gammapy.spectrum.models.ExponentialCutoffPowerLaw.html)
# * [gammapy.spectrum.models.LogParabola](http://docs.gammapy.org/0.8/api/gammapy.spectrum.models.LogParabola.html)
# 
# To compute flux points (a.k.a. "SED" = "spectral energy distribution")
# 
# * [gammapy.spectrum.SpectrumResult](http://docs.gammapy.org/0.8/api/gammapy.spectrum.SpectrumResult.html)
# * [gammapy.spectrum.FluxPoints](http://docs.gammapy.org/0.8/api/gammapy.spectrum.FluxPoints.html)
# * [gammapy.spectrum.SpectrumEnergyGroupMaker](http://docs.gammapy.org/0.8/api/gammapy.spectrum.SpectrumEnergyGroupMaker.html)
# * [gammapy.spectrum.FluxPointEstimator](http://docs.gammapy.org/0.8/api/gammapy.spectrum.FluxPointEstimator.html)
# 
# Feedback welcome!
...
# ## Estimate background
# 
# Next we will manually perform a background estimate by placing [reflected regions](http://docs.gammapy.org/0.8/background/reflected.html) around the pointing position and looking at the source statistics. This will result in a  [gammapy.background.BackgroundEstimate](http://docs.gammapy.org/0.8/api/gammapy.background.BackgroundEstimate.html) that serves as input for other classes in gammapy.
...
# ## Source statistic
# 
# Next we're going to look at the overall source statistics in our signal region. For more info about what debug plots you can create check out the [ObservationSummary](http://docs.gammapy.org/0.8/api/gammapy.data.ObservationSummary.html#gammapy.data.ObservationSummary) class.
...
# 
# Now we will look at the files we just created. We will use the [SpectrumObservation](http://docs.gammapy.org/0.8/api/gammapy.spectrum.SpectrumObservation.html) object that are still in memory from the extraction step. Note, however, that you could also read them from disk if you have written them in the step above. The ``ANALYSIS_DIR`` folder contains 4 ``FITS`` files for each observation. These files are described in detail [here](https://gamma-astro-data-formats.readthedocs.io/en/latest/spectra/ogip/index.html). In short, they correspond to the on vector, the off vector, the effectie area, and the energy dispersion.
...
# * if you interested in available fit statistics checkout [gammapy.stats](http://docs.gammapy.org/0.8/stats/index.html)
