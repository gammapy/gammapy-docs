...
# ## Introduction
# 
# This notebook explains how to use the functions and classes in [gammapy.spectrum](https://docs.gammapy.org/0.9/spectrum/index.html) in order to simulate and fit spectra.
# 
...
# 
# * [gammapy.irf.EffectiveAreaTable](https://docs.gammapy.org/0.9/api/gammapy.irf.EffectiveAreaTable.html)
# * [gammapy.irf.EnergyDispersion](https://docs.gammapy.org/0.9/api/gammapy.irf.EnergyDispersion)
# * [gammapy.spectrum.SpectrumObservation](https://docs.gammapy.org/0.9/api/gammapy.spectrum.SpectrumObservation.html)
# * [gammapy.spectrum.SpectrumSimulation](https://docs.gammapy.org/0.9/api/gammapy.spectrum.SpectrumSimulation.html)
...
# ## What's next
# 
# In this tutorial we learnd how to simulate and fit data using a toy detector. Go to [gammapy.spectrum](https://docs.gammapy.org/0.9/spectrum/index.html) to see what else you can do with gammapy.
