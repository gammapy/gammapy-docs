...
.. autoclass:: RegionNDMap
   ...
   .. autosummary::
      ...
      ~RegionNDMap.is_allclose
      ~RegionNDMap.iter_by_axis
      ~RegionNDMap.iter_by_axis_data
      ~RegionNDMap.iter_by_image
      ~RegionNDMap.iter_by_image_data
      ~RegionNDMap.iter_by_image_index
      ...
      ~RegionNDMap.rename_axes
      ~RegionNDMap.reorder_axes
      ~RegionNDMap.reproject_by_image
      ~RegionNDMap.reproject_to_geom
      ~RegionNDMap.resample
      ~RegionNDMap.resample_axis
      ~RegionNDMap.sample_coord
      ~RegionNDMap.set_by_coord
      ~RegionNDMap.set_by_idx
      ~RegionNDMap.set_by_pix
      ~RegionNDMap.slice_by_idx
      ~RegionNDMap.split_by_axis
      ~RegionNDMap.stack
