...
.. autoclass:: HpxMap
   ...
   .. autosummary::
      ...
      ~HpxMap.get_by_idx
      ~HpxMap.get_by_pix
      ~HpxMap.get_image_by_coord
      ~HpxMap.get_image_by_idx
      ~HpxMap.get_image_by_pix
      ~HpxMap.get_spectrum
      ~HpxMap.integral
      ~HpxMap.interp_by_coord
      ~HpxMap.interp_by_pix
      ~HpxMap.interp_to_geom
      ~HpxMap.is_allclose
      ~HpxMap.iter_by_axis
      ~HpxMap.iter_by_image
      ~HpxMap.iter_by_image_data
      ~HpxMap.iter_by_image_index
      ~HpxMap.mask_nearest_position
      ~HpxMap.normalize
      ~HpxMap.pad
      ~HpxMap.plot_grid
      ~HpxMap.plot_interactive
      ~HpxMap.read
      ~HpxMap.reduce
      ~HpxMap.reduce_over_axes
      ~HpxMap.rename_axes
      ~HpxMap.reorder_axes
      ~HpxMap.reproject_by_image
      ~HpxMap.reproject_to_geom
      ~HpxMap.resample
      ~HpxMap.resample_axis
      ~HpxMap.sample_coord
      ~HpxMap.set_by_coord
      ~HpxMap.set_by_idx
      ~HpxMap.set_by_pix
      ~HpxMap.slice_by_idx
      ~HpxMap.split_by_axis
      ~HpxMap.sum_over_axes
      ~HpxMap.to_cube
      ~HpxMap.to_hdu
      ~HpxMap.to_hdulist
      ~HpxMap.to_swapped
