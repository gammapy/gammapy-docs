...
.. autoclass:: FluxPointsEstimator
   ...
   .. autosummary::
      ...
      ~FluxPointsEstimator.copy
      ~FluxPointsEstimator.estimate_best_fit
      ~FluxPointsEstimator.estimate_counts
      ~FluxPointsEstimator.estimate_errn_errp
      ~FluxPointsEstimator.estimate_flux_point
      ~FluxPointsEstimator.estimate_npred
      ~FluxPointsEstimator.estimate_npred_excess
      ~FluxPointsEstimator.estimate_scan
      ~FluxPointsEstimator.estimate_ts
      ~FluxPointsEstimator.estimate_ul
      ~FluxPointsEstimator.get_scale_model
